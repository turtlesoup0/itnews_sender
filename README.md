...
### ITFIND 주간기술동향 (수요일)
- **자동 조회**: RSS 피드에서 최신 주간기술동향 자동 조회
- **PDF 다운로드**: Playwright 브라우저 자동화로 StreamDocs 뷰어에서 PDF 추출
- **자동 첨부**: 수요일 전자신문 발송 시 주간기술동향 PDF 함께 첨부
- **별도 Lambda**: 독립적인 Lambda 함수로 분리하여 안정성 향상
